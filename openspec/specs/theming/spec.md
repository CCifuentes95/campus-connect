...
## Purpose
App-wide light/dark theming: a semantic design-token layer that flips by theme, a persisted (no-flash SSR) theme selection defaulting to the OS preference, and a toggle in the top nav.

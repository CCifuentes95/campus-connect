# ui-quality Specification

## Purpose
The cross-cutting quality bar for the web UI: Web Interface Guidelines compliance (accessibility, focus, semantics, theming), fidelity to the claude-design mockups, and the skill-driven definition-of-done every screen is built and reviewed against.
